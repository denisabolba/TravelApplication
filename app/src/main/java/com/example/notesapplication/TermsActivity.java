...
public class TermsActivity extends AppCompatActivity {
    ...
    public String fileName = "HTML/TermsAndConditions.html";
    @Override
    ...
    void showMenu() {
        PopupMenu popupMenu = new PopupMenu(TermsActivity.this, rightIcon);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                if (menuItem.getTitle() == "Home") {
                    ...
                    startActivity(new Intent(TermsActivity.this, HomeMenuActivity.class));
                    finish();
                    return true;
                }
                ...
                if (menuItem.getTitle() == "Contact Support") {
                    startActivity(new Intent(TermsActivity.this, ContactSupportActivity.class));
                    return true;
                }
                return false;
            }
