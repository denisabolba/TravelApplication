...
public class RomaActivity extends AppCompatActivity {
    ...
    public String fileName = "HTML/Roma.html";
    ...
    void showMenu() {
        PopupMenu popupMenu = new PopupMenu(RomaActivity.this, rightIcon);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                if (menuItem.getTitle() == "Home") {
                    ...
                    startActivity(new Intent(RomaActivity.this, HomeMenuActivity.class));
                    finish();
                    return true;
                }
                if (menuItem.getTitle() == "Logout") {
                    FirebaseAuth.getInstance().signOut();
                    startActivity(new Intent(RomaActivity.this, LoginActivity.class));
                    finish();
                    return true;
                }
                if (menuItem.getTitle() == "Profile") {
                    startActivity(new Intent(RomaActivity.this, ProfileActivity.class));
                    return true;
                }
                if (menuItem.getTitle() == "Contact Support") {
                    startActivity(new Intent(RomaActivity.this, ContactSupportActivity.class));
                    return true;
                }
                return false;
            }
