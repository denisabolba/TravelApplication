...
public class PrivacyPolicyActivity extends AppCompatActivity {
    ...
    public String fileName = "HTML/PrivacyPolicy.html";
    @Override
    ...
    void showMenu() {
        PopupMenu popupMenu = new PopupMenu(PrivacyPolicyActivity.this, rightIcon);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                if (menuItem.getTitle() == "Home") {
                    ...
                    startActivity(new Intent(PrivacyPolicyActivity.this, HomeMenuActivity.class));
                    finish();
                    return true;
                }
                ...
                if (menuItem.getTitle() == "Profile") {
                    startActivity(new Intent(PrivacyPolicyActivity.this, ProfileActivity.class));
                    return true;
                }
                if (menuItem.getTitle() == "Contact Support") {
                    startActivity(new Intent(PrivacyPolicyActivity.this, ContactSupportActivity.class));
                    return true;
                }
                return false;
            }
