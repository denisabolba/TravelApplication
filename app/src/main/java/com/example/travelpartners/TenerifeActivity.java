...
public class TenerifeActivity extends AppCompatActivity {
    ...
    public String fileName = "HTML/Tenerife.html";
    ...
    void showMenu() {
        PopupMenu popupMenu = new PopupMenu(TenerifeActivity.this, rightIcon);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                if (menuItem.getTitle() == "Home") {
                    ...
                    startActivity(new Intent(TenerifeActivity.this, HomeMenuActivity.class));
                    finish();
                    return true;
                }
                if (menuItem.getTitle() == "Logout") {
                    FirebaseAuth.getInstance().signOut();
                    startActivity(new Intent(TenerifeActivity.this, LoginActivity.class));
                    finish();
                    return true;
                }
                if (menuItem.getTitle() == "Profile") {
                    startActivity(new Intent(TenerifeActivity.this, ProfileActivity.class));
                    return true;
                }
                if (menuItem.getTitle() == "Contact Support") {
                    startActivity(new Intent(TenerifeActivity.this, ContactSupportActivity.class));
                    return true;
                }
                return false;
            }
