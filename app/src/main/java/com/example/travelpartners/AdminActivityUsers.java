            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    case R.id.nav_home:
                        ...
                        Intent intent = new Intent(AdminActivityUsers.this, MainActivity2.class);
                    ...
                    case R.id.nav_trips:
                        ...
                        return true;
                    case R.id.nav_chat:
                        startActivity(new Intent(AdminActivityUsers.this, MainActivity2.class));
                        drawerLayout.closeDrawer(GravityCompat.START);
                        return true;
                    case R.id.nav_profile:
                        startActivity(new Intent(AdminActivityUsers.this, ProfileActivity.class));
                        drawerLayout.closeDrawer(GravityCompat.START);
                        return true;
                    case R.id.nav_logout:
                        Dialog dialog = new Dialog(AdminActivityUsers.this);
                    ...
                    case R.id.nav_contact:
                        startActivity(new Intent(AdminActivityUsers.this, ContactSupportActivity.class));
                        drawerLayout.closeDrawer(GravityCompat.START);
                        return true;
                }
