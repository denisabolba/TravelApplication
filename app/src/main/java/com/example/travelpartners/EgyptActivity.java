...
public class EgyptActivity extends AppCompatActivity {
    ...
    public String fileName = "HTML/Egypt.html";
    ...
    void showMenu() {
        PopupMenu popupMenu = new PopupMenu(EgyptActivity.this, rightIcon);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                if (menuItem.getTitle() == "Home") {
                    ...
                    startActivity(new Intent(EgyptActivity.this, HomeMenuActivity.class));
                    finish();
                    return true;
                }
                if (menuItem.getTitle() == "Logout") {
                    FirebaseAuth.getInstance().signOut();
                    startActivity(new Intent(EgyptActivity.this, LoginActivity.class));
                    finish();
                    return true;
                }
                if (menuItem.getTitle() == "Profile") {
                    startActivity(new Intent(EgyptActivity.this, ProfileActivity.class));
                    return true;
                }
                if (menuItem.getTitle() == "Contact Support") {
                    startActivity(new Intent(EgyptActivity.this, ContactSupportActivity.class));
                    return true;
                }
                return false;
            }
